...
<nav className="bg-blue-500 border-gray-200 dark:bg-gray-900">
  ...
  <Link to="/" className="flex items-center space-x-3 rtl:space-x-reverse">
      <img src="https://www.google.com/imgres?imgurl=https%3A%2F%2Fimg.freepik.com%2Fpremium-vector%2Fnepal-round-flag-icon-with-shadow_6724-5103.jpg&tbnid=9uRQ4HC-wyMUmM&vet=10CAYQxiAoBWoXChMIkLWAhNqNiAMVAAAAAB0AAAAAEA8..i&imgrefurl=https%3A%2F%2Fwww.freepik.com%2Fpremium-vector%2Fnepal-round-flag-icon-with-shadow_69504725.htm&docid=vLPWGXIUAoobNM&w=626&h=626&itg=1&q=nepal%20flag%20icon&ved=0CAYQxiAoBWoXChMIkLWAhNqNiAMVAAAAAB0AAAAAEA8" className="h-8" alt="" />
      <span className="self-center text-2xl font-semibold whitespace-nowrap dark:text-white">Blogs Nepal</span>
  </Link>
  <div className="flex md:order-2">
  <ul className="flex flex-col p-4 md:p-2 mt-4 font-medium  bg-blue-50 md:space-x-8 rtl:space-x-reverse md:flex-row md:mt-0 md:border-0 md:bg-gray-50 dark:bg-gray-800 md:dark:bg-gray-900 dark:border-gray-700">
        <li>
